const SettingsPage = () => {
	return (
		<div className='h-full w-full'>
			<h2 className='text-2xl font-semibold mb-4 table pb-1 after:bg-base-300 after:absolute after:left-0 after:bottom-0 after:h-0.5 after:w-full'>
				Preferences
			</h2>
			...
			<div className='join join-vertical w-full'>
				...
				<div className='collapse-title bg-base-200 text-md card rounded-t-none border-t-2 flex flex-row justify-between items-center gap-4 pr-4'>
					...
					<select className='select select-sm select-bordered w-full max-w-fit'>
