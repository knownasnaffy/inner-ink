export default function Hero() {
	return (
		<div className=''>
			<div className='container mx-auto flex max-w-5xl translate-y-8 flex-col items-center justify-center gap-2 py-40 text-center max-lg:px-4'>
				<div className='prose prose-xl'>
					<h1 className='mb-2'>Inner Ink</h1>
					<p className='mt-0'>
